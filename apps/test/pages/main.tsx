...
const Main: NextPage = () => {
  ...
  return (
    <UserProvider>
      ...
      <label className="text-base font-normal text-gray-700">This page should hang on Lighthouse when deployed on Netlify</label>
        <button className="bg-blue-400 hover:bg-blue-500 text-white mt-10 py-2 px-5 rounded select-none w-48 font-bold" onClick={onClickLogout}>Logout</button>
        </div>
    </UserProvider>
  );
};
